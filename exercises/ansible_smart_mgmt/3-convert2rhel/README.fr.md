...
#### 2\. Installer une stack applicative 3-tiers
...
#### 6\. Vérifier la stack application 3-tiers sur les nœuds CentOS - post Centos update, pre Convert2RHEL
